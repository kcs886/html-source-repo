...
<script type="text/javascript" src="https://www.jeasyui.com/easyui/jquery.easyui.min.js"></script>
    ...
    <script type="text/javascript">
    	...
    	function empUPD(){
    		...
    		if(g_empno==0){
    			$.messager.alert("info","수정할 사원을 먼저 선택해주세요.");
    			empList();
    			return; //empUPD함수 탈출
    		}else{
    			$.ajax({
    				...
    				,success:function(date){
    					...
    					for(var i=0;i<arr.length;i++){
    						$("#u_empno").textbox('setValue',arr[i].EMPNO);
...
<%
	...
	if("update".equals(mode) || "insert".equals(mode) || "delete".equals(mode)){
%>
	<script type="text/javascript">
		empList();
	</script>
...
%>
	...
	<div id="dlg_upd" data-options="closed:true, title:'사원정보 수정',footer:'#d_upd'" class="easyui-dialog" style="width:100%;max-width:480px;padding:30px 60px">
		<form id="f_upd">
			<div style="margin-bottom:5px">
			<input class="easyui-textbox" id="u_empno" name="empno" label="사원번호" labelPosition="top" data-options="prompt:'Enter a EmpNO'" style="width:150px">
			</div>
			<div style="margin-bottom:5px">
			<input class="easyui-textbox" id="u_ename" name="ename" label="사원명" labelPosition="top" data-options="prompt:'Enter a ENAME'" style="width:250px">
			</div>
			<div style="margin-bottom:5px">
			<input class="easyui-textbox" id="u_job" name="job" label="JOB" labelPosition="top" data-options="prompt:'Enter a JOB'" style="width:250px">
			</div>
			<div style="margin-bottom:5px">
			<input class="easyui-textbox" id="u_mgr" name="mgr" label="MGR" labelPosition="top" data-options="prompt:'Enter a MGR'" style="width:250px">
			</div>
			<div style="margin-bottom:5px">
			<input class="easyui-textbox" id="u_hiredate" name="hiredate" label="일사일자" labelPosition="top" data-options="prompt:'Enter a HIRE_DATE'" style="width:250px">
			</div>
			<div style="margin-bottom:5px">
			<input class="easyui-textbox" id="u_sal" name="sal" label="급여" labelPosition="top" data-options="prompt:'Enter a SAL'" style="width:250px">
			</div>
			<div style="margin-bottom:5px">
			<input class="easyui-textbox" id="u_comm" name="comm" label="인센티브" labelPosition="top" data-options="prompt:'Enter a COMM'" style="width:250px">
			</div>
			<div style="margin-bottom:5px">
			<input class="easyui-combobox" id="u_deptno" name="deptno" label="부서번호" labelPosition="top"
				  data-options="prompt:'Enter a 부서번호' 
              	 ,valueField: 'DEPTNO'
                 ,textField: 'DNAME'
                 ,url: 'jsonDeptList.jsp'
			...
			<div style="margin-bottom:5px">
			<input class="easyui-textbox" id="u_zipcode" name="zipcode" label="우편번호" labelPosition="top" data-options="prompt:'Enter a ZIPCODE'" style="width:130px">
			<a id="btn_zipcode" href="#" class="easyui-linkbutton">우편번호찾기</a>
			</div>
			<div style="margin-bottom:5px">
